...
repo --name=sl6-os-i686         --mirrorlist=http://chloe/scientific/6.0/i386/os/
repo --name=sl6-fastbugs-i686   --mirrorlist=http://chloe/scientific/6.0/i386/updates/fastbugs/
repo --name=sl6-security-i686   --mirrorlist=http://chloe/scientific/6.0/i386/updates/security/
