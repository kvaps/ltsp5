...
repo --name=sl6-os-x86_64         --mirrorlist=http://chloe/scientific/6.0/x86_64/os/
repo --name=sl6-fastbugs-x86_64   --mirrorlist=http://chloe/scientific/6.0/x86_64/updates/fastbugs/
repo --name=sl6-security-x86_64   --mirrorlist=http://chloe/scientific/6.0/x86_64/updates/security/
