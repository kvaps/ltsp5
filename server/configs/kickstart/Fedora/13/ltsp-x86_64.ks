...
repo --name=rawhide-13-x86_64 --mirrorlist=http://mirrors.fedoraproject.org/mirrorlist?repo=rawhide&arch=x86_64
#repo --name=temporary-13-x86_64 --baseurl=http://togami.com/~k12linux-temporary/fedora/13/x86_64/
